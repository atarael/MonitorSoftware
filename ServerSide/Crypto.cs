...
namespace ServerSide
{
    ...
    class Crypto
    {
        ...
        {
            // IMPORTENT! Key encryption is required in the configuration file 
            // but the issue of encryption is not within the scope of our project 
            // so we did not delay it 
